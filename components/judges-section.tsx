    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">本コンテストの審査を担当した5名の審査員をご紹介します</p>
        </div>
                  ...
                  <div className="relative w-36 h-36 mb-5 overflow-hidden rounded-full ring-4 ring-gray-100 group-hover:ring-purple-200 transition-all duration-300">
                    <img
                      ...
                      className={`w-full h-full ${
                        judge.name.includes('くりえみ') ? 'object-contain bg-gray-50 scale-125 translate-y-2' : 
                        judge.name.includes('大森') ? 'object-contain bg-gray-50 scale-150 translate-y-8' : 
                        'object-cover'
                      }`}
                      loading="lazy"
                    />
        ...
        <Card className="shadow-xl bg-gradient-to-br from-white to-purple-50/30 border-purple-100">
          <CardContent className="p-8 md:p-12">
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-lg p-6">
                <h4 className="font-semibold text-purple-700 mb-3">作品の特徴と評価ポイント</h4>
                <p>
                  特に印象的だったのは、技術的な完成度の高さと同時に、それぞれの作品が持つ物語性や感情の表現力です。
                  構図の工夫、光の捉え方、モデルとの調和など、多角的な視点から評価させていただきました。
                </p>
              </div>
              
              <div className="bg-white/70 backdrop-blur-sm rounded-lg p-6">
                <h4 className="font-semibold text-purple-700 mb-3">参加者へのメッセージ</h4>
                <p>
